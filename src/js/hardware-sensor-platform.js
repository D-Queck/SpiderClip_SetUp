...
export function initHardwareCanvas() {
  ...
  container.append(overlayCenter);
  ...
  opt0.value = '';
  opt0.textContent = 'Show All';
  selPart.append(opt0);
  overlayRight.append(btnAuto, selPart);
  container.append(overlayRight);
  ...
  function loadModel(idx) {
    ...
    nameEl.textContent = name;      // setzt Überschrift oben Mitte
    btnAuto.disabled = true;
    selPart.disabled = true;

    loader.load(url, gltf => {
      root = gltf.scene;
      // zentrieren & skalieren optional...
      ...
      controls.minDistance = maxD*0.5; controls.maxDistance = maxD*5;
    });
  }
